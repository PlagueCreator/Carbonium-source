...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `SparkleBOT@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
        ...
        if (message.root.attributes.type == "chat") {
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/SparkleBOT/config.json', JSON.stringify({
            ...
            'message': {
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "ns": "Fortnite",
                        "party_id": partyID,
                        "account_id": "SparkleBOT",
                        "account_dn": "SparkleBOT",
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "SparkleBOT",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"SparkleBOT\",\"dn\":\"SparkleBOT\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/SparkleBOT/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `SparkleBOT${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `SparkleBOT${this.NumberOfBot}`,
                            "account_dn": `SparkleBOT`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"SparkleBOT${this.NumberOfBot}\",\"dn\":\"SparkleBOT\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `SparkleBOT`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "ns": "Fortnite",
                                "party_id": PartyId || "LobbyBotPartyLMFAO",
                                "account_id": `SparkleBOT${counterLol}`,
                                "account_dn": `SparkleBOT`,
                                "member_state_removed": [],
                                "member_state_updated": member_state_updated,
                                "joined_at": new Date(),
